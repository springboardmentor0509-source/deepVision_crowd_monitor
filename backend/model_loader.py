...
class ModelManager:
    def __init__(self):
        ...
        self.models = {}
        self.models_dir = os.path.join(project_root, "models and code")
        self.model_paths = {
            "SimpleCNN": os.path.join(self.models_dir, "best_simplecnn.pth"),
            "CSRNet": os.path.join(self.models_dir, "best_csrnet_model.pth"),
            "MobileNetCSRNet": os.path.join(self.models_dir, "best_mobilenet_csrnet_model.pth"),
            "RandomForest": os.path.join(self.models_dir, "random_forest_model.pkl"),
        }
