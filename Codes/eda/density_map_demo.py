...
def generate_density_map(img_shape, points, sigma=15):
    """
    Generate a Gaussian density map for a given image shape and annotation points.
    img_shape: tuple (height, width)
    points: list of [x, y] coordinates for each person
...
def show_density_example(img_path, gt_path):
    """
